            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Tambah Komponen</h1>
                    </div>
                        ...
                        <div class="col">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('admin/komponen/tambah') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="id_komponen">ID Komponen</label>
                                            <input class="form-control" type="text" name="id_komponen" value="KOM<?= sprintf("%03s", $id_komponen) ?>" readonly />
                                        </div>
