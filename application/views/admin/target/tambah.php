                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo site_url('admin/target/tambah') ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectpicker <?php echo form_error('id_indikator') ? 'is-invalid' : '' ?>" name="id_indikator" id="id_indikator" data-live-search="true" title="Pilih Indikator...">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('tahun') ? 'is-invalid' : '' ?>" type="text" name="tahun" placeholder="Tahun Target" />
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control <?php echo form_error('target') ? 'is-invalid' : '' ?>" type="text" name="target" placeholder="Target" />
                                            <div class="invalid-feedback">
